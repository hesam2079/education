...
contract TestVotingSystem {
    ...
    // تست اعلام نتایج و شناسایی برنده
    function testDeclareResultsAndVerifyWinner() public {
        // ایجاد انتخابات
        string;
        ...
        // چک کردن تعداد آرا برای هر کاندیدا قبل از اعلام نتایج
        ...
        // اعلام نتایج
        votingSystem.declareResults(1);

        // چک کردن برنده
        string memory winner = votingSystem.getWinner(1);
        Assert.equal(winner, "کاندیدا 1", "کاندیدا 1 باید برنده باشد");
    }
}
